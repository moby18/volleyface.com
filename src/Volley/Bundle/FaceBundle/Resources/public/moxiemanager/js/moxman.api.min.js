    ...
    i(l, [], function () {
        ...
        return function (r) {
            ...
            function T(e, t, n, i, o, a) {
                ...
                for (n = n || 0, i = i || 0, o = o || O.width, a = a || O.height, u = i; a > u; u += c)for (l = n; o > l; l += c)d.push({
                    x: l,
                    y: u,
                    w: l + c > o ? o - l : c,
                    h: u + c > a ? a - u : c
        ...
        function i(o, a) {
            ...
            a ? "string" === e.typeOf(a) && (a = {data: a}) : a = {}, e.extend(this, {
        ...
        function f() {
            ...
            var R = this, T = {
                ...
                responseText: null,
                response: null
            }, A = !0, k, S, D = {}, F, I, M = null, N = null, H = !1, P = !1, O = !1, L = !1, W = !1, z = !1, B, U, j = null, V = null, q = {}, X, G = g;
            e.extend(this, T, {
                uid: e.guid("uid_"), upload: new d, open: function (t, a, s, l, u) {
                    var c;
        ...
        return e.extend({
            render: function (e) {
                t.create({
                    ...
                    items: [{
                        type: "form",
                        items: [{label: "Username", name: "username", type: "textbox", minWidth: 250}, {
                            label: "Password",
                            name: "password",
                            type: "textbox",
                            subtype: "password",
        ...
        return e.extend({
            renderAsDialog: function (e) {
                t.create({
                    ...
                    buttons: [{text: "Create", subtype: "primary", onclick: "submit"}, {
                        text: "Cancel",
                        onclick: "close"
                    }],
                    onsubmit: function (t) {
        ...
        return e.extend({
            renderAsDialog: function (e) {
                ...
                r.getFile(e.path, function (t) {
                    t.getFileContents(function (i) {
                        n.create({
                            ...
                            buttons: [{text: "Save", subtype: "primary", onclick: "submit"}, {
                                text: "Cancel",
                                onclick: "close"
                            }]
                        }).renderTo(document.body).reflow()
                ...
                var x, y, b, w, _, E, C = [{
                    ...
                    items: [{
                        type: "buttongroup",
                        items: [{text: "Save", name: "savebtn", icon: "save", onclick: u("save")}, {
                            text: "Revert",
                            name: "revert",
                            onclick: function () {
                                b.revert()
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            items: [{
                                text: "Alter",
                                fixed: !0,
                                items: [{text: "Resize", onclick: u("resize")}, {
                                    text: "Crop",
                                    onclick: u("crop")
        ...
        return e.extend({
            init: function (e) {
                ...
                function C() {
                    n.upload({
                        path: lt.path, onupload: function (e) {
                            w(lt.path, function () {
                                I(e.files), x()
                            })
                        }
                ...
                function T() {
                    n.zip({
                        from: b().toPathArray(), to: lt.path, onbeforecreate: h, oncreate: function (e) {
                            w(lt.path, function () {
                                M(e.to), x()
                            })
                        }
                ...
                function O(e) {
                    n.createDir({
                        path: lt.path, template: e, onbeforecreate: h, oncreate: function (e) {
                            w(lt.path, function () {
                                M(e.file), x()
                            })
                        }
                ...
                function Q(e) {
                    ...
                    n.append({
                        text: "Folder", icon: "folder", onclick: function () {
                            O()
                        }
                ...
                function nt(e) {
                    ...
                    if (!n.isDefaultPrevented()) {
                        var i = [{
                            name: "clipboard",
                            menu: [{text: "Cut", icon: "cut", shortcut: "Ctrl+X", onclick: D}, {
                                text: "Copy",
                                icon: "copy",
                                shortcut: "Ctrl+C",
                                onclick: F
                            ...
                            name: "tools",
                            menu: [{text: "View", name: "view", icon: "view", onclick: S}, {
                                text: "Edit",
                                name: "edit",
                                icon: "edit",
                                onclick: _
                            ...
                            name: "zip",
                            menu: [{text: "Zip", name: "zip", icon: "zip", onclick: T}, {
                                text: "Unzip",
                                name: "unzip",
                                onclick: A
                            }]
                            ...
                            name: "remove",
                            menu: [{text: "Remove", name: "delete", icon: "delete", shortcut: "Delete", onclick: k}]
                        }];
                ...
                function it() {
                    ...
                    return t && u.each(t, function (t) {
                        ...
                        icon: "upload",
                        onclick: C
                    } : {type: "menubutton", name: "upload", text: "Upload", icon: "upload", menu: e}
                }
                ...
                st = i.create("window", {
                    ...
                    items: [{
                        ...
                        items: [{
                            type: "treeview",
                            autoScroll: !0,
                            items: [{text: "FileSystems", name: "filesystems", fixed: !0, items: []}]
                        }]
                    }, {
                        region: "center",
                        layout: "flex",
            ...
            renderAsDialog: function (e) {
                n.getFile(e.from, function (n) {
                    ...
                    n && n.isFile ? (r = i.extname(n.name), o = i.basename(n.name, r)) : o = n.name, t.create({
                        ...
                        buttons: [{text: "Rename", subtype: "primary", onclick: "submit"}, {
                            text: "Cancel",
                            onclick: "close"
                        }]
                    }).renderTo(document.body).reflow()
                    ...
                    f.getConfig(function (f) {
                        ...
                        var k = i.create({
                            ...
                            items: [{
                                ...
                                maxWidth: 600
                            }, {type: "label", text: ["Max size: {0}", E]}, y ? {
                                type: "label",
                                name: "dragmsg",
                        ...
                        }).renderTo(document.body).reflow(), S = new l({
