(function (exports, undefined) {
    ...
    define(__moxman_util_Loader, [], function () {
        ...
        var Loader = {
            maxLoadTime: 5, load: function (urls, loadedCallback, errorCallback) {
                    ...
                    oninsert: function (args) {
                        ...
                        tinymce.each(args.files, function (file, i) {
                            ...
                            if (isImage) {
                                ...
                                html += processTemplate(editor.getParam("moxiemanager_image_template", '<div class="col-sm-4 col-xs-6 col-md-3 col-lg-3"><a class="thumbnail fancybox" href="{$url}" rel="ligthbox" data-lightbox="lightbox"><img class="img-responsive" src="{$meta.thumb_url}" alt="" /></a></div>'), file);
                            } else {
